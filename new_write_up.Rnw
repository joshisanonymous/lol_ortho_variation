  ...
  \section{Introduction}
    ...
    \subsection{Previous work on (lol)}
      ...
      \subsubsection{As an orthographic variable}
        ...
        Indeed, just such lengthening is readily apparent in the tweets collected for the present study, though an argument for what exact function this has or whether it even represents a pragmatic function has yet to be made.
        [Insert example of lol lengthening]
