    ...
    \subsection{Coding}
      ...
      \subsubsection{Social variables}
        ...
        \paragraph{Community detection}
          ...
          For instance, Figure \ref{fig:example} is a very simply hypothetical network consisting of Joe, Kelly, Bob, and Ted.
          In the network, and Joe, Kelly, and Bob all know each other, but the only person who knows Ted is Bob.
          ...
          In the case of the present study, I define a tie as a directed tweet and the strength of a tie as the number of directed tweets between two users.
...
@
          ...
          % Blondel et al. 2008: It essentially starts with all the nodes and then, one by one, moves them and calculates if there was a gain or loss in modularity (Q). If there was a gain, the move is kept. This continues until a maximum Q is achieved. (There's a second phase before repeating this, as well, but I don't understand it well enough.)
