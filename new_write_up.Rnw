  ...
  \section{Introduction}
    ...
    \subsection{Orthographic variation}
      ...
      \subsubsection{Connection to grammar}
        ...
        A somewhat more structural function of orthographic variation is exemplified in Hinrichs and White-Sustaíta's (2011) work on Jamaican Creole, which has English as its superstrate.
        They found that speakers of the language living outside of Jamaica would vary between spellings such as \orth{mi} and \orth{me}, both pronounced [mi], based on the syntactic function within the sentence, using the former for as a subject pronun and the latter in all other cases.
        ...
        However, they note that it could also be said that this variation indicates a complex relationship to English and perhaps non-Creole-speakers \parencite[Hinrichs and White-Sustaíta 2011, as cited in][p.~165]{eisenstein_systematic_2015}, making its function not only structural but also social.

        % Community
        The previous example presents locutors perhaps taking a particular stance but may also be interpreted as signaling group membership or a lack thereof.
        A clearer example of the latter comes from \citeauthor{androutsopoulos_potentials_2008}'s (\citeyear{androutsopoulos_potentials_2008}) later work examining German hip-hop websites.
        A case of spelling variation on these sites was the use of \orth{z} where \orth{s} is expected.
        \textcite{androutsopoulos_potentials_2008} quoted one of his informants as explicitly claiming that such spelling signaled an extreme dedication to hip-hop (pp.~12-13), which shows just how salient orthographic variation can be.

        % Pragmatics
        As \textcite{androutsopoulos_non-standard_2000} argued, orthographic variants ``signal certain attitudes or evoke certain frame of interpretation by establishing a contrast to the text's spelling regularities or to the default spelling of a linguistic item'' (p.~517).
