% Introduction
  ...
  % Orthographic variation
    ...
    % It's important to identify a typology of orthographic variation, something Androutsopoulos (2000) has done.
    ...
    % Phonological connection
      % Eisenstein (2015) found four factors, one linguistic and three social, that favored the absence of <g> in (ing) on Twitter: being a verb, being an @-message, sent from a county with high Black population, sent from a county with high population density (176).
    ...
    % Strictly non-phonological orthographic variation
    ...
    % Pragmatic functions of lol
      % Capitalization or reduplication could reasonably be used to represent different degrees of laughter
        % In fact, this could be quantified in terms of Levenshtein distance as was done by I. Stewart et al. (2017) for other orthographic variables (4).
          % They found this to be meaningful in terms of language change as newcomers to the Instagram community they examined generally prefered variants with greater distances from the original (5-6).
      ...
      % Specific evidence for lol
        % Schneier (2021) argued that lol in his data was used like laughter to mitigate face threatening acts but also to coordinate turn taking, unlike laughter (5).
          % Specifically, Schneier (2021) found keybursts to be short in intiial position, arguing that this quickness is a response to a need to save face for one's interlocutor, whereas the slower turn final keybursts may represent more deliberation on the impact of one's own message (17-18).
...
% Methods
  % Data collection
    % Source: Twitter
      % Characteristics of Twitter
        ...
        % Also has the advantage of being used by a broad range of demographics.
        ...
        % Stylistic variation (conceptualized as individual variation) on Twitter
          ...
          % A more typical treatment of style from a sociolinguistic standpoint was Ilbury's (2020) work on gay men from the south of English on Twitter.
            ...
            % Additionally, Ilbury (2020) found that @-messages directed at other gay men were more likely to include AAVE features (256), echoing Bell's (1984) audience design framework for style.
      ...
      % General considerations
        ...
        % Autocomplete
          % Schneier (2021) was able to identify when his participants used autocomplete on their phones with his KeyLog software (9), but this isn't always possible.
  ...
  % Data coding
    % Social variables
      % It can be difficult to confirm social variables for users of CMC in large scale studies like this.
...
% Discussion
  % Did this work like a phonological variable?
