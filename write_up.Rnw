...
\begin{document}
  ...
  \label{sec:results}
    ...
    What is immediately apparent is that the mode for this community stems mostly from \Sexpr{usersSummary2265[7, "User"]}'s linguistic behavior in that they produced far more tokens of (lol) than anyone else and were also quite consistent in their spelling with a diversity of \Sexpr{round(usersSummary2265[7, "Diversity"], 2)}.
    \Sexpr{usersSummary2265[7, "User"]}'s place in this community is fairly central, as well, with a PageRank of \Sexpr{round(usersSummary2265[7, "PageRank"], 4)}, which despite the narrow range of PageRanks, is one of the highest among any user analyzed in this corpus for any community.
    \begin{table}[tbhp]
      \centering
    ...
    Digging deeper into the results for individual users such as \Sexpr{usersSummary2265[7, "User"]} who have relatively high PageRanks as well as those who have particularly low PageRanks may prove enlightening.
    ...
    \begin{table}[tbhp]
      ...
      \begin{tabular}{l l r l r r}
        User                              & Community                              & PageRank                                        & Mode                              & Diversity         & Tokens \rule{0pt}{14pt} \\
        \hline
        \multicolumn{6}{c}{Highest PageRanks} \rule{0pt}{14pt} \\
        \Sexpr{usersSummary[900, "User"]} & \Sexpr{usersSummary[900, "Community"]} & \Sexpr{round(usersSummary[900, "PageRank"], 5)} & \Sexpr{usersSummary[900, "Mode"]} & \Sexpr{round(usersSummary[900, "Diversity"], 2)} & \rule{0pt}{14pt} \Sexpr{usersSummary[900, "Tokens"]} \\
        \Sexpr{usersSummary[50, "User"]} & \Sexpr{usersSummary[50, "Community"]} & \Sexpr{round(usersSummary[50, "PageRank"], 5)} & \Sexpr{usersSummary[50, "Mode"]} & \Sexpr{round(usersSummary[50, "Diversity"], 2)} & \Sexpr{usersSummary[50, "Tokens"]} \\
        \Sexpr{usersSummary[893, "User"]} & \Sexpr{usersSummary[893, "Community"]} & \Sexpr{round(usersSummary[893, "PageRank"], 5)} & \Sexpr{usersSummary[893, "Mode"]} & \Sexpr{round(usersSummary[893, "Diversity"], 2)} & \Sexpr{usersSummary[893, "Tokens"]} \\
        \Sexpr{usersSummary[915, "User"]} & \Sexpr{usersSummary[915, "Community"]} & \Sexpr{round(usersSummary[915, "PageRank"], 5)} & \Sexpr{usersSummary[915, "Mode"]} & \Sexpr{round(usersSummary[915, "Diversity"], 2)} & \Sexpr{usersSummary[915, "Tokens"]} \\
        \Sexpr{usersSummary[933, "User"]} & \Sexpr{usersSummary[933, "Community"]} & \Sexpr{round(usersSummary[933, "PageRank"], 5)} & \Sexpr{usersSummary[933, "Mode"]} & \Sexpr{round(usersSummary[933, "Diversity"], 2)} & \Sexpr{usersSummary[933, "Tokens"]} \\
        \hline
        \multicolumn{6}{c}{Lowest PageRanks} \rule{0pt}{14pt} \\
        \Sexpr{usersSummary[583, "User"]} & \Sexpr{usersSummary[583, "Community"]} & \Sexpr{round(usersSummary[583, "PageRank"], 5)} & \Sexpr{usersSummary[583, "Mode"]} & \Sexpr{round(usersSummary[583, "Diversity"], 2)} & \rule{0pt}{14pt} \Sexpr{usersSummary[583, "Tokens"]} \\
        \Sexpr{usersSummary[671, "User"]} & \Sexpr{usersSummary[671, "Community"]} & \Sexpr{round(usersSummary[671, "PageRank"], 5)} & \Sexpr{usersSummary[671, "Mode"]} & \Sexpr{round(usersSummary[671, "Diversity"], 2)} & \Sexpr{usersSummary[671, "Tokens"]} \\
        \Sexpr{usersSummary[1093, "User"]} & \Sexpr{usersSummary[1093, "Community"]} & \Sexpr{round(usersSummary[1093, "PageRank"], 5)} & \Sexpr{usersSummary[1093, "Mode"]} & \Sexpr{round(usersSummary[1093, "Diversity"], 2)} & \Sexpr{usersSummary[1093, "Tokens"]} \\
        \Sexpr{usersSummary[1106, "User"]} & \Sexpr{usersSummary[1106, "Community"]} & \Sexpr{round(usersSummary[1106, "PageRank"], 5)} & \Sexpr{usersSummary[1106, "Mode"]} & \Sexpr{round(usersSummary[1106, "Diversity"], 2)} & \Sexpr{usersSummary[1106, "Tokens"]} \\
        \Sexpr{usersSummary[1116, "User"]} & \Sexpr{usersSummary[1116, "Community"]} & \Sexpr{round(usersSummary[1116, "PageRank"], 5)} & \Sexpr{usersSummary[1116, "Mode"]} & \Sexpr{round(usersSummary[1116, "Diversity"], 2)} & \Sexpr{usersSummary[1116, "Tokens"]} \\
      \end{tabular}
    \end{table}
  \section{Discussion}
