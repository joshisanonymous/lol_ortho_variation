\documentclass{article}
  ...
  \title{Centrality and Variability of (lol)}
...
\begin{document}
  ...
  \section{Introduction}
    ...
    Twitter and social network analysis give researchers tools to approach this issue in a quantitative way.
  ...
  \section{Method}
    ...
    These tweets were used 
     containing upwards of 4,000 tokens of (lol).
    In this case, (lol) was a lexical variable and so included variants such as \lexi{rofl} and even \lexi{mdr} from French \lexi{mort de rire}, so the exact number of orthographic variants of \lexi{lol} alone is not given.
    % Data coding
